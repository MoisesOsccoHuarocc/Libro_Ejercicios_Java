...
public class EJERCICIO_02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("PROGRAMA QUE MULTIPLICA LA DIAGONAL PRINCIPAL Y SECUNDARIA DE UNA MATRIZ 10x10");
        //Definimos la matriz	
        ...
        System.out.println("La multiplicacion de las diagonales es: " + prod);
